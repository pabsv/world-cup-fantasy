  ...
  if (!profile?.is_admin) {
    return (
      <div className="card p-8 text-center">
        ...
        <p className="mt-1 text-sm text-muted">You don&apos;t have access to this page.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-1 text-sm text-muted">Set the lock time and enter real group results.</p>
      </header>

      {comp && <AdminLockForm locksAt={comp.locks_at} />}

      <section>
        <h2 className="mb-1 px-1 text-xs font-semibold uppercase tracking-widest text-muted">
          Group results
        </h2>
